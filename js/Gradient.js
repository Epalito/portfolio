...
// Créez une instance de la classe Gradient
let gradient = new Gradient();

// Connectez le gradient à un élément canvas
gradient.initGradient('#gradient-canvas');

// Commencez l'animation du gradient
gradient.play();

// Pour utiliser le gradient comme arrière-plan du body, vous pouvez définir le body pour être transparent et positionner le canvas derrière tout le contenu de la page.
